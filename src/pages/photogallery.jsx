...
class Photogallery extends Component {
  ...
  render() {
    ...
    let s = this.props.photo.find(n => {
      return n.one_id === this.props.match.params.id;
    });
                    ...
                    <div className="photo__content">
                      {t.map(a => (
                        <div className="photo__item">
                          <Link  to={"/photogallery/" + a.one_id}></Link>
                          <div className="row">
                            <div className="col-12">
                              <h2 className="photo__item-title">{a.name}</h2>
                            </div>
                            <div className="col-12 icons">
                              <div className="d-flex">
                                <span className="day mr-5">
                                  <i className="fa fa-calendar mr-2"></i>3
                                  Апреля 2019
                                </span>
