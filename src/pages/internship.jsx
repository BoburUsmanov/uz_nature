...
class Internship extends Component {
  render() {
    return (
      <div className="requirements general__container">
        <div className="container-fluid">
          <div className="row">
            <div className="col-8">
              <div className="requirements__box h-100">
                <div className="row">
                  <div className="col-12 mb-2">
                    <ul className="news__links d-flex">
                      ...
                      <li>
                        <Link to="/news">Стажировка</Link>
                      </li>
                    </ul>
                  </div>
                  <div className="col-12">
                    <Title title="Стажировка" />
                  </div>
                  ...
                  <div className="col-12">
                    <div className="requirements__content">
                      ...
                      Ipsum. Where does it come from? Contrary to popular
                      ...
                      by H. Rackham. Where does it come from? Contrary to
                      ...
                      1914 translation by H. Rackham. The standard chunk of
                      ...
                      versions from the 1914 translation by H. Rackham. The
                      standard chunk of Lorem Ipsum used since the 1500s is
                      reproduced below for those interested. Sections 1.10.32
                      and 1.10.33 from "de Finibus Bonorum et Malorum" by Cicero
                      are also reproduced in their exact original form,
                      accompanied by English versions from the 1914 translation
                      by H. Rackham. The standard chunk of Lorem Ipsum used
                      since the 1500s is reproduced below for those interested.
                      Sections 1.10.32 and 1.10.33 from "de Finibus Bonorum et
                      Malorum" by Cicero are also reproduced in their exact
                      original form, accompanied by English versions from the
